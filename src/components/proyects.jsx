...
export default function Proyects() {
  ...
  return (
    <div
      id="proyectos"
      className="section lg:max-w-4xl md:max-w-2xl container mx-auto p-5 mt-20 flex flex-col gap-y-16"
    >
      ...
      <div className="flex text-center items-center justify-center">
        {" "}
        <a
          className="duration-500 hover:text-purple-500 hover:scale-125"
          href="/blog"
        >
          ¿Quieres ver todos mis proyectos? clickeame
        </a>
      </div>
    </div>
  );
